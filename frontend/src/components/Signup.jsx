                ...
                <form onSubmit={onSubmitHandler} action=''>
                    ...
                    <div className='flex items-center my-4'>
                        <div className='flex items-center'>
                            ...
                            <input type="checkbox" defaultChecked className="checkbox mx-2" value={user.gender} checked={user.gender === 'male'} onChange={() => { handleCheckbox('male') }} />
                        </div>
                        <div className='flex items-center mx-4'>
                            <p className='text-black'>Female</p>
                            <input type="checkbox" defaultChecked className="checkbox mx-2" value={user.gender} checked={user.gender === 'female'} onChange={() => { handleCheckbox('female') }} />
                        </div>
                    </div>
